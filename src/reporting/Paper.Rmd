...
### Conclusions  
This study examined how movie runtime influences IMDb ratings and whether this relationship is moderated by genre (Comedy, Adventure, Action) and release period (2011–2015 vs. 2016–2020). Using a dataset of over 20,000 ratings on IMDb, we estimated an OLS regression with interaction terms, controlling for audience size through log-transformed vote counts.  
After running the OLS regression with interaction terms we found the following:  
...
- **Genre differences**: Action films were rated significantly lower than Comedy, while Adventure films were rated slightly higher. Further, both Action and Adventure showed different runtime–rating slopes compared to Comedy, suggesting genre conventions influence how audiences perceive film length.  
...
- **Votes as control variable**: The number of audience votes was a strong predictor, confirming that widely viewed films tend to receive higher and more stable ratings.  
...
- **Film studios**:  
  - For Action films, keeping runtimes tighter may help maintain audience satisfaction, as longer runtimes appear to lower the ratings.  
  - Adventure films can sustain longer runtimes, which may support more complex storytelling without lowering the ratings.  
  - Comedy films remain best received at shorter, more conventional lengths.  

- **Streaming platforms**:  
  - Since the 2016–2020 period shows lower ratings in general, platforms may need to adjust recommendation algorithms or promotional strategies to counteract declining audience evaluations.  
  - Improving recommendations by runtime preferences (shorter comedies, longer adventures) could improve user satisfaction.  

- **Cinemas and marketing teams**:  
  - Marketing should emphasize the large scale and immersion for longer Adventure films, while highlighting pacing and/or efficiency for Action and Comedy.  
...
- The period split (2011–2015 vs. 2016–2020) captures the rise of streaming but does not fully account for other industry shifts (e.g., franchise dominance, COVID-19 disruptions).  

Future research could expand to other genres, platforms, and audience measures (for example box office revenues, streaming completion rates) to build a fuller picture of how runtime affects audience perception in different contexts.  